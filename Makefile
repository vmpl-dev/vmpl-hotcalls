...
pkgdatadir = $(datadir)/hotcalls
pkglibdir = $(libdir)/hotcalls
pkglibexecdir = $(libexecdir)/hotcalls
...
libhotcalls_la_LIBADD =
am__dirstamp = $(am__leading_dot)dirstamp
am_libhotcalls_la_OBJECTS = src/hotcalls.lo src/spinlock.lo
libhotcalls_la_OBJECTS = $(am_libhotcalls_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
libhotcalls_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
	$(AM_CFLAGS) $(CFLAGS) $(libhotcalls_la_LDFLAGS) $(LDFLAGS) -o \
	$@
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/../ar-lib \
	...
	$(top_srcdir)/../missing $(top_srcdir)/include/config.h.in \
	AUTHORS COPYING ChangeLog INSTALL NEWS README.md
...
ACLOCAL = ${SHELL} '/home/benshan/vmpl-process/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} '/home/benshan/vmpl-process/missing' autoconf
AUTOHEADER = ${SHELL} '/home/benshan/vmpl-process/missing' autoheader
AUTOMAKE = ${SHELL} '/home/benshan/vmpl-process/missing' automake-1.16
AWK = gawk
CC = musl-gcc
CCAS = musl-gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} '/home/benshan/vmpl-process/missing' makeinfo
MANIFEST_TOOL = :
...
PACKAGE = hotcalls
PACKAGE_BUGREPORT = 
PACKAGE_NAME = hotcalls
PACKAGE_STRING = hotcalls 1.0 your-email@example.com
PACKAGE_TARNAME = hotcalls
PACKAGE_URL = 
PACKAGE_VERSION = 1.0 your-email@example.com
PATH_SEPARATOR = :
RANLIB = ranlib
SED = /usr/bin/sed
SET_MAKE = 
SHELL = /bin/bash
STRIP = strip
VERSION = 1.0 your-email@example.com
abs_builddir = /home/benshan/vmpl-process/vmpl-hotcalls
abs_srcdir = /home/benshan/vmpl-process/vmpl-hotcalls
abs_top_builddir = /home/benshan/vmpl-process/vmpl-hotcalls
abs_top_srcdir = /home/benshan/vmpl-process/vmpl-hotcalls
ac_ct_AR = 
ac_ct_CC = musl-gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/benshan/vmpl-process/install-sh
...
src/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/$(DEPDIR)
	@: > src/$(DEPDIR)/$(am__dirstamp)
src/hotcalls.lo: src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/spinlock.lo: src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)

libhotcalls.la: $(libhotcalls_la_OBJECTS) $(libhotcalls_la_DEPENDENCIES) $(EXTRA_libhotcalls_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libhotcalls_la_LINK) -rpath $(libdir) $(libhotcalls_la_OBJECTS) $(libhotcalls_la_LIBADD) $(LIBS)
src/hot_calls_test.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
